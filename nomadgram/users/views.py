...
from nomadgram.notifications import views as notifiactions_views
...
class FollowUser(APIView):
    ...
    def post(self, request, user_id, format=None):
        ...
        notifiactions_views.create_notification(user, user_to_follow, 'follow')
...
class UserFollowers(APIView):
    ...
    def get (self, request, username, format=None):
        ...
        user_followers = target_user.followers.all()
...
class UserFollowing(APIView):
    ...
    def get (self, request, username, format=None):
        ...
        user_following = target_user.following.all()
